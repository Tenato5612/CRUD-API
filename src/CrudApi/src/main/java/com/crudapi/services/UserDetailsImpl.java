...
public class UserDetailsImpl implements UserDetails{
    ...
    public UserDetailsImpl(long id, String name, String username, String email, String password, StatusUser status, Collection<? extends GrantedAuthority> authorities) {
        this.id = id;
        this.name = name;
